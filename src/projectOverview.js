...
function ProjectOverview({proj, proj:{title, cardSide, image, intro, skills, color}}) {
    ...
    return(
        <div className="row text-left">
            <div className={`px-4 px-lg-0 col-12 col-lg-5 offset-lg-1 order-2 ${cardSide === "r" ? "order-lg-1" : "order-lg-2"}`}>
                <h1 style={{ color: color }} className="mt-2 mt-lg-5 font-weight-bold">{title}</h1>
            ...
            <div className={`px-0 col-12 col-lg-5 order-1 ${cardSide === "l" ? "order-lg-1" : "order-lg-2 ml-md-auto"}`}>
